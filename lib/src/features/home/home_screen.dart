      ...
      child: Column(
        ...
        children: [
          ...
          PatiSectionHeader(
            ...
            subtitle: l10n.todayTasksPlanned(3),
          ),
          ...
          PatiSectionHeader(
            ...
            subtitle: l10n.quickLogSubtitle,
          ),
          const SizedBox(height: PatiSpace.md),
          SizedBox(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                return PatiIconTile(
                  ...
                  semanticHint: l10n.quickLogHint('Misket'),
...
class _PetAvatar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      button: true,
      label: l10n.activePetChange('Misket'),
      child: InkWell(
        onTap: onTap,
...
class _PetHeroCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      height: 286,
      child: PetPhotoSurface(
        semanticLabel: l10n.petHeroSemantic(
          'Misket',
          'British Shorthair',
          '2.4 kg',
        ),
...
class _TodayTimeline extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final l10n = AppLocalizations.of(context);
    final vaccineDate =
        MaterialLocalizations.of(context).formatShortDate(DateTime(2026, 10, 24));
    return PatiSoftCard(
      ...
      child: Column(
        children: [
          _TimelineItem(
            ...
            time: '09:00',
            title: l10n.supplementVitamin,
            detail: l10n.dailySupplement,
            completed: true,
          ),
          const Divider(),
          _TimelineItem(
          ...
          _TimelineItem(
            ...
            time: vaccineDate,
            title: l10n.mixedVaccine,
            detail: l10n.upcomingHealthTask,
            warning: true,
          ),
        ],
      ),
...
class _TimelineItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final l10n = AppLocalizations.of(context);
    final semantic = completed
        ? '$time, $title, $detail, ${l10n.completed}'
        : '$time, $title, $detail';
    return Semantics(
      label: semantic,
      child: Padding(
...
class _CareSnapshot extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        PatiSectionHeader(title: l10n.latestStatus),
        const SizedBox(height: PatiSpace.md),
        Row(
          children: [
            Expanded(
